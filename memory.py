...
# Mengatur API key
openai_api_key = "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"  # Ganti dengan API key kamu
...
_DEFAULT_TEMPLATE = """Berikut percakapan persahabatan antara manusia berumur 10 tahun dan AI. AI ini banyak bicara dan memberikan banyak cerita yang menarik dari konteksnya. Jika AI tidak mengetahui jawaban atas sebuah pertanyaan, AI dengan jujur mengatakan bahwa ia tidak mengetahuinya.
